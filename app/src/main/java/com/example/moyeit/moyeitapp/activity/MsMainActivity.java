        ...
        myStudyList.enqueue(new Callback<ListDto>() {
            ...
            public void onResponse(Call<ListDto> call, Response<ListDto> response) {
                ...
                for(int i =0; i<list.size(); i++){
                        String region = global.toRegion(Integer.parseInt(list.get(i).getRegion()));
                        list.get(i).setRegion(region);
                }
...
class ListViewAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        region.setText("<"+String.valueOf(src.get(position).getRegion())+">");
